...
<Link className="flex items-center gap-3 rounded-xl bg-primary/10 px-4 py-3 text-primary transition-colors" to="/">
<span className="material-symbols-outlined">dashboard</span>
<span className="font-bold">Dashboard</span>
</Link>
<Link className="flex items-center gap-3 rounded-xl px-4 py-3 text-slate-500 hover:bg-slate-50 transition-colors" to="/">
...
<Link className="text-sm font-semibold text-primary hover:underline" to="/">View All</Link>
</div>
...
<Link className="text-sm font-semibold text-primary hover:underline" to="/">Manage</Link>
</div>
...
<Link className="flex flex-1 flex-col items-center justify-center text-primary" to="/">
<span className="material-symbols-outlined">dashboard</span>
<span className="text-[10px] font-bold">Home</span>
</Link>
<Link className="flex flex-1 flex-col items-center justify-center text-slate-400" to="/">
<span className="material-symbols-outlined">calendar_today</span>
