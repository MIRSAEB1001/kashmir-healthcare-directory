...
<nav className="hidden md:flex items-center gap-8"><Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Find Doctors</Link>
...
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">About</Link></nav>
</div>
<div className="flex items-center gap-8">
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Login</Link>
...
<div className="ml-4 flex items-center gap-3 border-l border-primary/10 pl-4">
<Link className="text-primary opacity-60 hover:opacity-100 transition-opacity" to="/">
