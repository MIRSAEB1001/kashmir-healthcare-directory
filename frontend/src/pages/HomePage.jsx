...
<h1 className="text-xl font-bold tracking-tight text-primary">Kashmir <span className="text-secondary">Kashmir Healthcare</span></h1>
</div>
<nav className="hidden md:flex items-center gap-8">
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Find Doctors</Link>
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Hospitals</Link>
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Clinics</Link>
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">Labs</Link>
<Link className="text-sm font-medium hover:text-primary transition-colors" to="/">About</Link>
<Link className="text-sm font-medium hover:text-primary transition-colors ml-4" to="/">Login</Link>
...
<Link className="text-primary font-bold text-sm hover:underline" to="/">View Profile</Link>
...
<button className="w-full py-3 bg-primary/5 text-primary rounded-xl font-bold hover:bg-primary hover:text-white transition-all">Apply Now</button>
</div>
<div className="bg-white dark:bg-slate-900 p-10 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-800 text-center space-y-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
...
<button className="w-full py-3 bg-secondary/5 text-secondary rounded-xl font-bold hover:bg-secondary hover:text-white transition-all">Apply Now</button>
</div>
<div className="bg-white dark:bg-slate-900 p-10 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-800 text-center space-y-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
...
<button className="w-full py-3 bg-accent-pink/5 text-accent-pink rounded-xl font-bold hover:bg-accent-pink hover:text-white transition-all">Apply Now</button>
</div>
</div>
</div>
</section>
...
<h2 className="text-lg font-bold tracking-tight text-primary">Kashmir <span className="text-secondary">Kashmir Healthcare</span></h2>
</div>
<p className="text-slate-500 text-sm max-w-sm leading-relaxed">
                    Dedicated to digitizing healthcare accessibility in the Kashmir valley. Your health, our priority.
                </p>
<div className="flex gap-4">
<Link className="text-slate-400 hover:text-primary transition-colors" to="/"><span className="material-symbols-outlined">social_leaderboard</span></Link>
...
<li><Link className="hover:text-primary" to="/">Find Doctors</Link></li>
<li><Link className="hover:text-primary" to="/">Medical Labs</Link></li>
<li><Link className="hover:text-primary" to="/">Hospitals</Link></li>
<li><Link className="hover:text-primary" to="/">Pharmacy</Link></li>
</ul>
</div>
<div className="space-y-4">
...
<li><Link className="hover:text-primary" to="/">Terms of Use</Link></li>
